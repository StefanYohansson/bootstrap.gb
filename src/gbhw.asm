...
DEF rTAC_ON        EQU 2
DEF rTAC_4096Hz       EQU 0
DEF rTAC_262144Hz     EQU 1
DEF rTAC_65536Hz      EQU 2
DEF rTAC_16384Hz      EQU 3
...
DEF rUNKN1      EQU $ff6c ; (FEh) Bit 0 (Read/Write) - CGB Mode Only
DEF rSVBK       EQU $ff70 ; CGB Mode Only - WRAM Bank
DEF rUNKN2      EQU $ff72 ; (00h) - Bit 0-7 (Read/Write)
DEF rUNKN3      EQU $ff73 ; (00h) - Bit 0-7 (Read/Write)
DEF rUNKN4      EQU $ff74 ; (00h) - Bit 0-7 (Read/Write) - CGB Mode Only
DEF rUNKN5      EQU $ff75 ; (8Fh) - Bit 4-6 (Read/Write)
DEF rUNKN6      EQU $ff76 ; (00h) - Always 00h (Read Only)
DEF rUNKN7      EQU $ff77 ; (00h) - Always 00h (Read Only)
DEF rIE         EQU $ffff ; Interrupt Enable (R/W)


; MBC3
DEF MBC3_SRAM     EQU $0000
DEF MBC3_ROMBank  EQU $2000
DEF MBC3_SRAMBank EQU $4000
DEF MBC3_Latch    EQU $6000
DEF MBC3_RTC      EQU $a000

; MBC5
DEF MBC5_SRAM     EQU $0000
DEF MBC5_ROMBank  EQU $2000
DEF MBC5_ROMBankH EQU $3000
DEF MBC5_SRAMBank EQU $4000
